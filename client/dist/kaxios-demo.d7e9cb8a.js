...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/kaxios/utils.js":[function(require,module,exports) {
"use strict";
...
function deepCopy(object) {
  ...
  for (var item in object) {
    if (object.hasOwnProperty(item) && object[item] != null && _typeof(object[item]) === 'object') {
...
function mergeConfig(object1, object2) {
  var target = deepCopy(object1);
  var source = deepCopy(object2);
...
},{}],"js/kaxios/interceptorManager.js":[function(require,module,exports) {
"use strict";
...
exports.default = InterceptorsManager;
},{}],"js/kaxios/kaxios.js":[function(require,module,exports) {
"use strict";
...
var _interceptorManager = _interopRequireDefault(require("./interceptorManager"));
...
/*#__PURE__*/
function () {
  function Kaxios(config) {
    _classCallCheck(this, Kaxios);
...
},{"./utils":"js/kaxios/utils.js","./interceptorManager":"js/kaxios/interceptorManager.js"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/kaxios/ajax.js":[function(require,module,exports) {
"use strict";
...
var _InstanceConfig = _interopRequireDefault(require("./InstanceConfig"));
  ...
  return new Promise(function (resolve, reject) {
    ...
    xhr.onload = function () {
      resolve({
        ...
        data: _InstanceConfig.default.transfromData(xhr.responseText)
      });
    };
...
},{"./InstanceConfig":"js/kaxios/InstanceConfig.js"}],"js/kaxios/InstanceConfig.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  adaptor: function adaptor(configs) {
    ...
    if ((typeof window === "undefined" ? "undefined" : _typeof(window)) === 'object') {
      return (0, _ajax.default)(configs);
    } else {
      console.log("nodeHttp");
    }
  },
  transfromData: function transfromData(res) {
    return res;
  }
};
exports.default = _default;
},{"./ajax":"js/kaxios/ajax.js"}],"js/kaxios/index.js":[function(require,module,exports) {
"use strict";
...
var _kaxios = _interopRequireDefault(require("./kaxios"));
...
console.log(_InstanceConfig.default);
var kaxios = new _kaxios.default(_InstanceConfig.default); //  kaxios = Function.prototype.bind(axios.request, kaxios);
//  kaxios = 
//  console.log(kaxios.get);

var _default = kaxios;
exports.default = _default;
},{"./kaxios":"js/kaxios/kaxios.js","axios":"node_modules/axios/index.js","./InstanceConfig":"js/kaxios/InstanceConfig.js"}],"js/kaxios-demo.js":[function(require,module,exports) {
"use strict";
...
console.log(_kaxios.default); // kaxios.defaults.adaptor = (configs) => {
// }

_kaxios.default.interceptors.request.use(function (configs) {
  console.log(1);
  return configs;
}, function () {
...
_kaxios.default.interceptors.response.use(function (res) {
...
},{"./kaxios":"js/kaxios/index.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","js/kaxios-demo.js"], null)
//# sourceMappingURL=/kaxios-demo.d7e9cb8a.js.map